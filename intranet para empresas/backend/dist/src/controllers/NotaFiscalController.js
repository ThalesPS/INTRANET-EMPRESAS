...
exports.NotaFiscalController = {
    async index(req, res) {
        try {
            ...
            const isRHOrFinanceiro = usuario.department === 'RH' ||
    ...
    async create(req, res) {
        try {
            const { colaboradorId, nomeColaborador, mesCompetencia, valor } = req.body;
            const file = req.file;
    ...
    async cobrarPendente(req, res) {
        try {
            ...
            await mailService_1.MailService.sendInvoiceReminder(email, name, mesCompetencia);
