...
exports.UserController = {
    ...
    async update(req, res) {
        try {
            ...
            const updateData = { bio, phone, skills, avatarUrl, coverUrl };
            ...
            if (currentUserRole === 'Desenvolvedor' || currentUserRole === 'RH') {
                ...
                if (password !== undefined && currentUserRole === 'Desenvolvedor')
    ...
    async create(req, res) {
        try {
            const { name, username, email, password, role, department, avatarUrl, coverUrl, bio, phone, manager, skills, birthDate, isManager, currentUserRole } = req.body;
            if (currentUserRole !== 'Desenvolvedor') {
