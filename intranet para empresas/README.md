...
Salve! Esse é o repositório principal da intranet . O projeto é dividido em duas partes: um backend em Node.js (com Express e Prisma) e um frontend em React (usando Vite, Tailwind v4 e Radix UI). 
